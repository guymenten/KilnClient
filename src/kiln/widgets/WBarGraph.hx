...
class WBarGraph extends WBase
{
	...
	var label				:JLabel;
	var thrRect				:AWSprite;
	var thrRectInAlarm		:AWSprite;
	 ...
	 * @param	name
	 */
	public function new(?funcMove:Dynamic->Void, ?funcStop:Dynamic->Void)
	{
		super();
		...
		Y =  16 * dY;
		thrRect 			= new AWSprite();
		thrRectInAlarm 		= new AWSprite();
		peakRect 			= new AWSprite();
