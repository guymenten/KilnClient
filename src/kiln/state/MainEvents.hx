...
class MainEvents
{
	...
	public static inline var EVT_MAIN_STATE:String			= "EVT_MAIN_STATE";	// Panel State Change
	...
	static public inline var EVT_STATE_REFRESH:String 		= "EVT_STATE_REFRESH";
...
class StateMachineEvent extends Event
{
	...
	public function new()
	{
		...
		super(MainEvents.EVT_MAIN_STATE);
	}
